import{V as s}from"./VFileInput-C17FCmKg.js";import{r as f,w as x,o as p,f as c,m as h,a2 as F,e as n,c as j,F as S,h as N,t as l,v as L,b as e,d as t}from"./main--Sxm5_s2.js";import{V as U}from"./VChip-B1-AfmoZ.js";import{_ as m}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{a,V}from"./VRow-iwFKqp57.js";import{_ as k}from"./AppCardCode-pIfmYr3w.js";import"./VField-B3XaJafD.js";import"./form-ByD6MPa6.js";import"./index-CGqMMtXP.js";import"./easing-CjukEv2V.js";import"./VInput-CrRB8sjj.js";import"./VImg-Za-rMnCD.js";import"./forwardRefs-C-GTDzx5.js";import"./VCounter-C_khUIuy.js";import"./VSlideGroup-DDUY1mOj.js";import"./VAvatar-YOWsFQVe.js";/* empty css              */import"./vue3-perfect-scrollbar.esm-BK9G7Rkn.js";import"./VCard-D_9YY7eU.js";import"./VCardText-B_32FgjQ.js";import"./VDivider-Cp-mvYZ4.js";const A={__name:"DemoFileInputLoading",setup(u){const o=f(),r=f(!0);return x(o,()=>{r.value=!o.value[0]}),(d,i)=>(p(),c(s,{modelValue:h(o),"onUpdate:modelValue":i[0]||(i[0]=_=>F(o)?o.value=_:null),loading:h(r),color:"primary",label:"File input",variant:"outlined"},null,8,["modelValue","loading"]))}},B={__name:"DemoFileInputSelectionSlot",setup(u){const o=f([]);return(r,d)=>(p(),c(s,{modelValue:h(o),"onUpdate:modelValue":d[0]||(d[0]=i=>F(o)?o.value=i:null),multiple:"",placeholder:"Upload your documents",label:"File input","prepend-icon":"tabler-paperclip"},{selection:n(({fileNames:i})=>[(p(!0),j(S,null,N(i,_=>(p(),c(U,{key:_,label:"",size:"small",color:"primary",class:"me-2"},{default:n(()=>[l(L(_),1)]),_:2},1024))),128))]),_:1},8,["modelValue"]))}},P={__name:"DemoFileInputValidation",setup(u){const o=[r=>!r||!r.length||r[0].size<1e6||"Avatar size should be less than 1 MB!"];return(r,d)=>(p(),c(s,{rules:o,label:"Avatar",accept:"image/png, image/jpeg, image/bmp",placeholder:"Pick an avatar","prepend-icon":"tabler-camera"}))}},R={};function M(u,o){return p(),c(s,{"show-size":"",label:"File input"})}const T=m(R,[["render",M]]),O={};function Y(u,o){return p(),c(s,{label:"File input","prepend-icon":"tabler-camera"})}const E=m(O,[["render",Y]]),W={};function q(u,o){return p(),c(s,{multiple:"",label:"File input"})}const G=m(W,[["render",q]]),H={};function J(u,o){return p(),c(s,{"show-size":"",counter:"",multiple:"",label:"File input"})}const K=m(H,[["render",J]]),Q={};function X(u,o){return p(),c(s,{chips:"",label:"File input w/ chips"})}const Z=m(Q,[["render",X]]),ee={};function le(u,o){return p(),c(s,{accept:"image/*",label:"File input"})}const te=m(ee,[["render",le]]),ne={};function oe(u,o){return p(),c(V,null,{default:n(()=>[e(a,{cols:"12",sm:"6"},{default:n(()=>[e(s,{label:"Outlined"})]),_:1}),e(a,{cols:"12",sm:"6"},{default:n(()=>[e(s,{label:"Filled",variant:"filled"})]),_:1}),e(a,{cols:"12",sm:"6"},{default:n(()=>[e(s,{label:"Solo",variant:"solo"})]),_:1}),e(a,{cols:"12",sm:"6"},{default:n(()=>[e(s,{label:"Plain",variant:"plain"})]),_:1}),e(a,{cols:"12",sm:"6"},{default:n(()=>[e(s,{label:"Underlined",variant:"underlined",density:"default"})]),_:1})]),_:1})}const ie=m(ne,[["render",oe]]),ae={};function se(u,o){return p(),c(s,{label:"File input",density:"compact"})}const pe=m(ae,[["render",se]]),ce={};function ue(u,o){return p(),c(s,{label:"File input"})}const re=m(ce,[["render",ue]]),me={ts:`<template>
  <VFileInput
    accept="image/*"
    label="File input"
  />
