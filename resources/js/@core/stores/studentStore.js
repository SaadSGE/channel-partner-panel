  ...
  actions: {
      ...
      try {
        ...
        const interestedUniversityRequest = {
          interested_university: formData.universityEntry?.length
            ? formData.universityEntry.map(entry => ({
        ...
        const educationalHistoryRequest = {
          educational_history: formData.educationalHistory?.length
            ? formData.educationalHistory.map(edu => ({
        ...
        const englishProficiencyRequest = {
          english_proficiency: formData.englishProficiency?.length
            ? formData.englishProficiency.map(prof => ({
    ...
    async getStudentDetails(id) {
      try {
        ...
        this.studentInfo = {
          generalInfo: studentData.general_info || {},
          educationalHistory: studentData.educational_histories || [],
          employmentHistory: studentData.employment_histories || [],
          englishProficiency: studentData.english_proficiency || [],
          interestedUniversity: studentData.interested_universities || [],
          documentPaths: studentData.documents || []
        };
