                ...
                <VCardText>
                    <div class="comment-section">
                        <VTimeline :density="dense">
                            <VTimelineItem v-for="(comm, index) in acoCoCommunications" :key="index" dot-color="primary"
                                size="small">
                                <template #opposite>
    ...
    <VDialog v-model="showAcoCoCommModal" max-width="500px">
        <VCard>
            ...
            <VCardActions class="pa-4">
                <VSpacer />
                <VBtn color="primary" :loading="isAcoCoCommLoading" :disabled="isAcoCoCommLoading"
                    @click="handleAddAcoCoComm">
