                ...
                <VWindowItem>
                    <div>
                        <VTimeline align="start" truncate-line="both" side="end" density="compact" line-thickness="1"
                            ...
                            <VTimelineItem icon="tabler-circle-check" dot-color="rgba(var(--v-theme-surface))"
                                icon-color="success" fill-dot size="20" :elevation="0">
                            ...
                            <VTimelineItem icon="tabler-map-pin" dot-color="rgba(var(--v-theme-surface))"
                                icon-color="primary" fill-dot size="20" :elevation="0">
