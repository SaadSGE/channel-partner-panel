    ...
    <AppCardActions title="New Application" :loading="isLoading" no-actions>
      ...
      <VForm ref="refForm" @submit.prevent="() => { }" class="form-padding">
        <VRow>
          ...
          <VCol cols="12" md="6">
            <AppAutocomplete v-model="passportCountry" :items="passportCountries" label="Country of Student Passport"
              placeholder="Select Country of Student's Passport" :rules="[requiredValidator]" />
          </VCol>
          ...
          <VCol cols="12" md="6">
            <AppAutocomplete v-model="university" :items="commonFunctionStore.universities" item-title="university_name"
